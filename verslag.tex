...
\noindent Met deze formule wordt gevraag of er 'A' always/altijd geen deadlock kan onstaan.

\subsubsection{Liveness}

Livness staat beschreven onder '\nameref{liveness}' op pagina \pageref{liveness}.\\

\noindent Om de garantie voor liveness te controleren wordt de volgende formule gebruikt: \\
